//Este es el archivo de la página principal de la aplicación Fixall.
// Contiene el diseño y la estructura de la página de inicio, incluyendo enlaces a otras páginas y un pie de página.
...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col items-center justify-center text-center p-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-5xl w-full mb-8 flex flex-col items-center justify-center">
