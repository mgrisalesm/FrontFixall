//Esta es la pagina para que el usuario inicie sesion como cliente, donde se le pide al usuario su correo y contraseña.//
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
          <div className="bg-white p-8 rounded-lg shadow-lg w-96 border border-gray-300 border-solid border-3">
            ...
            <form>
             ...
             <Link href="/cliente" className="bg-blue-600 text-white px-8 py-2 rounded-lg hover:bg-blue-70 ml-20 text-center">
            Iniciar Sesión
            </Link>
            </form>
